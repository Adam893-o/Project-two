...
<head>
  <meta charset="utf-8">
  <title>My Websites - Jupiter</title>
...
<body>
  ...
  <div class="content-wrapper">
    ...
    <section>
      <img src="media/image1.jpg" alt="A stunning look at Jupiter and the great red spot">
      ...
      <div id="img2">
        <img src="media/image2.jpg" alt="Jupiter's surface marked by asteroids over the years">
      </div>
      <p>Above shows an image of the marks that Jupiter received while destroying tons of asteroids over the many years.</p>
      <h2>Other Facts About Planet Jupiter</h2>
      <img src="media/image3.jpg" alt="Size comparison between Jupiter and other planets in our solar system">
      ...
      <ul>
        ...
        <li>Unlike Earth, where storms stop due to land masses, Jupiter has no land since it's a Gas Giant. So, its storms will continue indefinitely.</li>
        <li>Jupiter is the fastest rotating planet in the entire solar system. One day on Jupiter lasts about 9 1/2 hours on Earth.</li>
        <li>Jupiter is mostly made of hydrogen and helium gas.</li>
        <li>Jupiter, like Saturn, has rings.</li>
        <li>Jupiter's great red spot is a gigantic cyclone, larger than Earth, and it has been raging for over three centuries.</li>
        <li>Because Jupiter is mostly made of hydrogen and helium gas like the sun, it is often called a "failed star" as it doesn't meet the conditions to become a star.</li>
        <li>Jupiter has many moons — around 95. The largest are <strong>Io</strong>, <strong>Callisto</strong>, <strong>Ganymede</strong>, and <strong>Europa</strong>.</li>
        <li>Jupiter's magnetic field is so strong that NASA's Juno spacecraft captured audio of what Jupiter sounds like.</li>
      </ul>
      <iframe width="400" height="300" src="https://www.youtube.com/embed/e3fqE01YYWs?si=7IFdZLB1Tiov8kD7" 
      ...
      <p>While we may never be able to see what's inside Jupiter due to the planet's immense power, we can still study and admire it for protecting us for so many years. However, nothing lasts forever; NASA studies have shown that the planet is shrinking. There are still many mysteries to discover about this fascinating planet, and we continue to explore what it has in store for us.</p>
